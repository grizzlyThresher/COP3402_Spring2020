...
1. You may run "./compile NAME_OF_INPUT_FILE" from your terminal. This will read in your input file, attempt to compile the program
	and print the results to a file labelled "output.txt".

2. You may run "./compile NAME_OF_INPUT_FILE NAME_OF_OUTPUT_FILE" from your terminal.
